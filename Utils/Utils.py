...
def log_retry(stage_name: str, chunk_id: int, retry_attempt:int, max_attempts) -> None:
    if retry_attempt == max_attempts:
        ...
        logger.info(f"{stage_name} for chunk {chunk_id} failed to execute, retrying attempt # {retry_attempt}")